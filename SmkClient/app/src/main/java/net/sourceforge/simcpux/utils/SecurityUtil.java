...
public class SecurityUtil {
    ...
    public static String subkey(String mainkey ,String cardNo){
        String key = SecurityUtil.desecb(mainkey, cardNo, 0);
        String key1 = SecurityUtil.desecb(mainkey, SecurityUtil.doXOR(cardNo, "FFFFFFFFFFFFFFFF"), 0);
        return key + key1;
    }
