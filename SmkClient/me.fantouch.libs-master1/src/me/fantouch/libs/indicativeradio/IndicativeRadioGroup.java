...
public class IndicativeRadioGroup extends RelativeLayout {
    ...
    private void initAttributesFromXml(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr==R.styleable.IndicativeRadioGroup_indicatorDrawable) {
                setIndicator(a
                        .getResourceId(attr, R.drawable.indicativeradio_default_indicator));
			}else if (attr==R.styleable.IndicativeRadioGroup_indicatorMoveAnimationDuration) {
				setIndicatorMoveAnimationDuration(a.getInt(attr, 500));
			}else if (attr==R.styleable.IndicativeRadioGroup_indicatorRestoreAnimationDuration) {
				setIndicatorRestoreAnimationDuration(a.getInt(attr, 1500));
			}else if (attr==R.styleable.IndicativeRadioGroup_hideAnimation) {
				setHideAnimation(a.getResourceId(attr, R.anim.indicativeradio_hide));
			}else if (attr==R.styleable.IndicativeRadioGroup_showAnimation) {
