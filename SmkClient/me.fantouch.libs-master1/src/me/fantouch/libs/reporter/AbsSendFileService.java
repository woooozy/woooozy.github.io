...
public abstract class AbsSendFileService extends Service {
    ...
    public static final String INTENT_PHONE = "me.fantouch.libs.reporter.INTENT_PHONE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("NFCActivity", "onStartCommand");
        int onStartCommandResult = super.onStartCommand(intent, flags, startId);
        telephone =  intent.getStringExtra(INTENT_PHONE);
